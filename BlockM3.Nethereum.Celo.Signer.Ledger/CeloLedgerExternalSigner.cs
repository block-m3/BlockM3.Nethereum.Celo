...
namespace BlockM3.Nethereum.Celo.Signer.Ledger
{
    public class CeloLedgerExternalSigner : CeloEthExternalSignerBase
    {
        ...
        public CeloLedgerExternalSigner(LedgerManager ledgerManager, uint index, bool legacyPath = false)
        {
            _index = index;
            _legacyPath = legacyPath;
            LedgerManager = ledgerManager;
            LedgerManager.SetCoinNumber(52752);
        }

        public CeloLedgerExternalSigner(LedgerManager ledgerManager, uint index, string customPath)
        {
            _index = index;
